...
#define log_deinit() (0)
#define get_logfile_des() (stderr)


#if 1
#define LOG_YELLOW(fmt, ...) do{}while(0)
#define LOG_RED(fmt, ...) do{}while(0)
#define LOG_GREEN(fmt, ...) do{}while(0)
#define LOG_BLUE(fmt, ...) do{}while(0)
