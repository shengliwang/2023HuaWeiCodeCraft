...
#define MAX_ROBOT_NUM       (6)        /*地图中最多的机器人数目*/
...
#define PRODUCT_TYPE_1      (1)
#define PRODUCT_TYPE_2      (2)
#define PRODUCT_TYPE_3      (3)
#define PRODUCT_TYPE_4      (4)
#define PRODUCT_TYPE_5      (5)
#define PRODUCT_TYPE_6      (6)
#define PRODUCT_TYPE_7      (7)
...
#define   ALGO1_EN  (0)     /*启用算法1*/
#define   ALGO2_EN  (1)     /*启用算法1*/
